...
fn create_test_server() -> TestServer {
    ...
    let app = Router::new()
        .route(
            "/",
            get(|| async { Html("<html><body>Welcome to Community Manager</body></html>") }),
        )
        .route(
            "/dashboard",
            get(|| async { Html("<html><body>Dashboard - Welcome back</body></html>") }),
        )
        .route(
            "/communities",
            get(|| async { Html("<html><body>Communities List</body></html>") }),
        )
        .route(
            "/communities/{id}",
            get(|| async { Html("<html><body>Community Detail</body></html>") }),
        )
        .route(
            "/businesses",
            get(|| async { Html("<html><body>Businesses List</body></html>") }),
        )
        .route(
            "/businesses/{id}",
            get(|| async { Html("<html><body>Business Detail</body></html>") }),
        )
        .route(
            "/chat",
            get(|| async { Html("<html><body>Chat</body></html>") }),
        )
        .route(
            "/chat/{room_id}",
            get(|| async { Html("<html><body>Chat Room</body></html>") }),
        )
        .route(
            "/governance",
            get(|| async { Html("<html><body>Governance</body></html>") }),
        )
        .route(
            "/poi",
            get(|| async { Html("<html><body>Points of Interest</body></html>") }),
        )
...
async fn test_homepage() {
    ...
    assert!(
        body.contains("Community Manager") || body.contains("Welcome"),
        "Homepage should have title"
    );
}
...
async fn test_dashboard() {
    ...
    assert!(
        body.contains("Dashboard") || body.contains("Welcome back"),
...
async fn test_communities_list() {
    ...
    assert!(
        body.contains("<html"),
        "Communities page should return HTML"
    );
    assert!(
        body.contains("Communities") || body.contains("community"),
        "Communities page should have communities content"
    );
}
...
async fn test_community_detail() {
    ...
    assert!(
        body.contains("<html"),
        "Community detail should return HTML"
    );
}
...
async fn test_businesses_list() {
    ...
    assert!(
        body.contains("Business") || body.contains("business"),
        "Businesses page should have business content"
    );
}
...
async fn test_governance() {
    ...
    assert!(
        body.contains("Governance") || body.contains("governance"),
        "Governance page should have governance content"
    );
}
