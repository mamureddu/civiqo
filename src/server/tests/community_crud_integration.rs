...
mod community_crud_integration_tests {
    ...
    async fn create_test_user(db: &Database) -> Uuid {
        ...
        // Users table: id, email, password_hash, provider, created_at, updated_at
        sqlx::query!(
    ...
    async fn test_creator_added_as_admin() {
        ...
        assert_eq!(member.unwrap().0, "admin", "Creator should have admin role");
    ...
    async fn test_update_owner_check() {
        ...
        assert_ne!(
            community.created_by, other_user_id,
            "Other user should not be owner"
        );
    ...
    async fn test_delete_community() {
        ...
        assert!(
            ...
            "Community should exist before delete"
        );
        ...
        assert!(
            ...
            "Community should not exist after delete"
        );
    ...
    async fn test_cascade_delete_members() {
        ...
        assert!(
            ...
            "Members should be deleted by CASCADE"
        );
    ...
    async fn test_sql_injection_prevention() {
        ...
        assert_eq!(
            result.name, "Test'; DROP TABLE communities; --",
    ...
    fn test_name_validation_max_length() {
        ...
        assert!(
            valid_name.len() <= 100,
            "Max length name should pass validation"
        );
    }
    ...
    fn test_description_validation_max_length() {
        ...
        assert!(
            valid_desc.len() <= 1000,
            "Max length description should pass validation"
        );
    }
