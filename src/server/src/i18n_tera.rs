...
use crate::i18n::{get_available_languages, Locale, LOCALES};
...
fn get_translations_for_locale(locale: &Locale) -> HashMap<String, String> {
    ...
    let keys = [
        ...
        "communities-filter-all",
        "communities-filter-public",
        "communities-filter-private",
        "communities-filter-my",
        "communities-empty",
        "communities-empty-subtitle",
        "community-public",
        "community-private",
        "community-verified",
        "community-join",
        ...
        "community-create-name-label",
        "community-create-name-placeholder",
        "community-create-name-hint",
        "community-create-name-validation",
        "community-create-description-label",
        "community-create-description-placeholder",
        "community-create-description-hint",
        "community-create-description-max",
        "community-create-privacy-title",
        "community-create-public-label",
        "community-create-public-hint",
        "community-create-approval-label",
        "community-create-approval-hint",
        "community-create-submit",
        "community-create-cancel",
        "community-create-creating",
        "community-create-success",
        "community-create-error",
        "community-create-redirect",
        "community-create-guidelines-title",
        "community-create-guideline-1",
        "community-create-guideline-2",
        "community-create-guideline-3",
        "community-create-guideline-4",
        // Validation
        "community-name-required",
        "community-name-min",
        "community-name-max",
        "community-name-invalid",
        "community-description-max",
        // Dashboard
        "dashboard-title",
        "dashboard-subtitle",
        "dashboard-stats-communities",
        "dashboard-stats-posts",
        "dashboard-stats-notifications",
        "dashboard-stats-activity",
        "dashboard-section-communities",
        "dashboard-section-communities-empty",
        "dashboard-section-communities-explore",
        "dashboard-section-communities-create",
        "dashboard-section-activity",
        "dashboard-section-activity-empty",
        "dashboard-quick-actions",
        "dashboard-action-create-community",
        "dashboard-action-create-post",
        ...
        "governance-tab-decisions",
        "governance-tab-polls",
        "proposals-title",
        "proposals-create",
        "proposals-empty",
        // Businesses
        "businesses-title",
        "businesses-subtitle",
        "businesses-search-placeholder",
        "businesses-empty",
        "businesses-empty-subtitle",
        // Chat
        "chat-title",
        "chat-subtitle",
        "chat-empty",
        ...
        "home-cta-explore",
        "home-cta-login",
        "home-feature-communities-title",
        "home-feature-communities-desc",
        "home-feature-chat-title",
        "home-feature-chat-desc",
        "home-feature-governance-title",
        "home-feature-governance-desc",
        "home-recent-communities",
        "home-view-all",
        "home-loading-communities",
    ];
