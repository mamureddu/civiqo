...
CREATE INDEX IF NOT EXISTS idx_analytics_community ON analytics_events(community_id);
...
CREATE INDEX IF NOT EXISTS idx_moderation_content_type ON moderation_queue(content_type);
CREATE INDEX IF NOT EXISTS idx_moderation_reported_by ON moderation_queue(reported_by);
CREATE INDEX IF NOT EXISTS idx_moderation_moderator ON moderation_queue(moderator_id);
...
CREATE INDEX IF NOT EXISTS idx_moderation_pending ON moderation_queue(status, priority, created_at) 
...
-- ============================================================================
-- ADMIN SETTINGS - REMOVED (using instance_settings in migration 009)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_community_stats_engagement ON community_stats(engagement_score DESC);
CREATE INDEX IF NOT EXISTS idx_community_stats_activity ON community_stats(last_activity_at DESC);
