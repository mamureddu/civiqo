...
## 📋 Phase 0: Agent 2 (Tech Lead) Planning

**👉 Switch to Claude 3.5 Sonnet model now**

### Step 0: Strategic Planning & Requirements
- **Analyze user's request** and extract core requirements
- **Define acceptance criteria** for the feature
- **Identify technical approach** and design decisions
- **Specify implementation details** and requirements for Agent 1
- **Document desiderata** (desired outcomes and constraints)
- **Create detailed specifications** for Agent 1 to follow
...
**👉 Switch to Claude 3.5 Haiku model now**

### Step 1: Implementation Planning
- **Review Agent 2's planning document** thoroughly
- **Understand all requirements and specifications**
- **Review existing codebase** for context and patterns
- **Check memories and documentation** for similar implementations
- **Create implementation todo list** based on Agent 2's guidance
- **Identify potential blockers** and escalation points
...
## 🔍 Phase 2: Agent 2 (Tech Lead) Verification & Approval
...
### Step 11: Documentation & Tracking
